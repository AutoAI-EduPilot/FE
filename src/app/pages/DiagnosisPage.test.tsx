...
import { restorePendingDiagnosis } from '../../features/diagnosis'
...
describe('DiagnosisPage', () => {
  ...
  it('renders correction message and links back to the general question flow', () => {
    renderDiagnosisPage()
    ...
    expect(screen.getByRole('heading', { name: '교정 메시지' })).toBeInTheDocument()
