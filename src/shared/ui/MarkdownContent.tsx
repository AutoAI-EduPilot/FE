  ...
  return (
    <div
      className={cx(
        ...
        '[&_blockquote]:my-2 [&_blockquote]:border-l-2 [&_blockquote]:border-stone-300 [&_blockquote]:pl-3',
        '[&_code]:rounded [&_code]:bg-white [&_code]:px-1 [&_code]:py-0.5 [&_code]:type-control',
        ...
        '[&_pre]:my-2 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:bg-white [&_pre]:p-2',
        '[&_strong]:font-bold',
        '[&_table]:my-3 [&_table]:min-w-full [&_table]:border-collapse [&_table]:bg-white [&_table]:type-caption',
        '[&_td]:border [&_td]:border-stone-200 [&_td]:px-2.5 [&_td]:py-2',
        '[&_th]:whitespace-nowrap [&_th]:border [&_th]:border-stone-200 [&_th]:bg-stone-50 [&_th]:px-2.5 [&_th]:py-2 [&_th]:text-left [&_th]:font-bold',
