...
async function handleDevRoute(
  ...
  if (method === 'GET' && pathname === '/api/admin/infra/cost') {
    return apiSuccess({
      ...
      currency: 'USD',
      daily: [
        { date: '2026-08-18', total: 1.38 },
        { date: '2026-08-19', total: 1.42 },
        { date: '2026-08-20', total: 1.51 },
        { date: '2026-08-21', total: 1.47 },
        { date: '2026-08-22', total: 1.62 },
        { date: '2026-08-23', total: 1.71 },
        { date: '2026-08-24', total: 1.79 },
        { date: '2026-08-25', total: 1.86 },
        { date: '2026-08-26', total: 1.91 },
        { date: '2026-08-27', total: 1.88 },
        { date: '2026-08-28', total: 1.94 },
        { date: '2026-08-29', total: 1.97 },
